...
from flcore.servers.serveravgFDA import FedAvgFDA
    ...
    for i in range(args.prev, args.times):
        ...
        if model_str == "mlr": # convex
            ...
            args.model = TransformerModel(ntoken=vocab_size, d_model=emb_dim, nhead=8, nlayers=2,
                                          numFed_classes=args.num_classes, max_len=max_len).to(args.device)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-data', "--dataset", type=str, default="TinyImagenet-pat")

    parser.add_argument('-nb', "--num_classes", type=int, default=200)
    parser.add_argument('-m', "--model", type=str, default="cnn")
    parser.add_argument('-lbs', "--batch_size", type=int, default=20)
    ...
    parser.add_argument('-algo', "--algorithm", type=str, default="FedFDA")
    ...
    parser.add_argument('-klw', "--kl_weight", type=float, default=30)
    parser.add_argument('-beta', "--beta_weight", type=float, default=1)
